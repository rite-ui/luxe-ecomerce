      ...
      <div className="w-full max-w-md space-y-8 border border-[var(--border-color)] p-8 sm:p-12 bg-[var(--bg-primary)] transition-colors duration-300">
        ...
        <form className="mt-8 space-y-6 text-left" onSubmit={handleSubmit}>
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label htmlFor="fullname" className="text-[10px] uppercase tracking-widest text-[var(--text-tertiary)]">
                Full Name
              </label>
              <input
                id="fullname"
        ...
        <div className="text-center pt-4 border-t border-[var(--border-color)]">
          <p className="text-xs text-[var(--text-tertiary)]">
            Already registered?{' '}
            <Link to="/login" className="font-semibold border-b border-[var(--text-primary)] text-[var(--text-primary)] hover:opacity-85 pb-0.5">
              Log In Instead
            </Link>
          </p>
        </div>
